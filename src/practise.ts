...
//===============================================================
function additon4(x:number,y:number){
    console.log(x+y)
}
additon4(12,3)
//===============================================================
let cities:string[]=["pune","nagpur","ahmednagar","nashik"]
console.log(cities)
//===============================================================
let arr:number[]=[11,22,33,44,55]
console.log(arr)
//================================================================
let mul:[string,string,number]=["rupa","dhokchaule",23]
mul.push("shlok")
console.log(mul)
//================================================================
// let obj={
...
function mul7(x:number,y:number):number{
    console.log(x+y)//17
    return(x*y)
}
let M=mul7(12,5)
console.log(M)//60
//============================================
let fruit:string[]=["banana","mango","orange","dragon"]
